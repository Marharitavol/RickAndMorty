...
class RMEpisodeListViewViewModel: NSObject {
    ...
    public func fetchEpisodes() { RMService.shared.execute(
        .listEpisodesRequests,
        expepecting: RMGetAllEpisodesResponse.self
    ) { [weak self] result in
        switch result {
    ...
    public func fetchAdditionalEpisode(url: URL) {
        ...
        RMService.shared.execute(request, expepecting: RMGetAllEpisodesResponse.self) { [weak self] result in
