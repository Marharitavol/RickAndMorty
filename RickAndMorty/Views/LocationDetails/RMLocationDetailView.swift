...
final class RMLocationDetailView: UIView {
    ...
    private func createCollectionView() -> UICollectionView {
        ...
        colllectionView.alpha = 0
        colllectionView.delegate = self
        colllectionView.dataSource = self
        colllectionView.register(RMEpisodeInfoCollectionViewCell.self, forCellWithReuseIdentifier: RMEpisodeInfoCollectionViewCell.cellIdentifier)
        colllectionView.register(RMCharacterCollectionViewCell.self, forCellWithReuseIdentifier: RMCharacterCollectionViewCell.cellIdentifier)
